...
- Provide only the [Restic](https://github.com/restic/restic) solution for storage involving Persistent Volumes due to the limitations of snapshot-based solutions in cross-cluster functionality. See https://velero.io/doc
...
2. **Implementation through Fleet-Manager** The fleet-manager will actively monitor these CRDs. Based on user configurations, it will:
...
3. **Status Aggregation** The fleet-manager will:
...
If a backup is attempted with a hostpath type, Velero will skip this resource and continue with the subsequent resources. Reference https://github.com/vmware-tanzu/velero/issues/4962
