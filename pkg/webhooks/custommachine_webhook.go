...
func (wh *CustomMachineWebhook) validate(in *v1alpha1.CustomMachine) error {
	...
	allErrs = append(allErrs, validateMaster(in.Spec.Master)...)
	allErrs = append(allErrs, validateNodes(in)...)
...
func validateCNI(in *v1alpha1.CustomMachine) field.ErrorList {
	var allErrs field.ErrorList
...
func validateMachineRef(in *v1alpha1.CustomMachine) field.ErrorList {
	var allErrs field.ErrorList
