...
func fetchDestinationCluster(ctx context.Context, client client.Client, fleet *backupapi.Destination) (map[ClusterKey]*fleetCluster, error) {



	// 设置了集群，但是集群不在 fleet 中如何处理
}
