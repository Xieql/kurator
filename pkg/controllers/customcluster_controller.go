...
const (
	...
	// HostsConfigFileName hostConfigmap's default name is customCluster.Name + "-" + HostsConfigFileName
	HostsConfigFileName = "hosts.yaml"
	// VarsConfigFileName varsConfigmap's default name is customCluster.Name + "-" + VarsConfigFileName
	VarsConfigFileName = "vars.yaml"
